...
export default class FullScreenContainer extends React.Component {
  ...
  _renderStatusBar(controlsDisplayed) {
    let isTranslucent = this.props.isStatusBarTranslucent;

    let props = {
      hidden: isTranslucent ? !controlsDisplayed : false,
      showHideTransition: 'slide',
      barStyle: 'light-content',
    }

    props.animated;
    if(isTranslucent) props.translucent;
  ...
  render() {
    ...
    return (
      <View style={styles.flex}>
        {this._renderStatusBar(controlsDisplayed)}
